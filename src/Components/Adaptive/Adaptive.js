...
const QQJEE = [
  ...
  { id: 8, question: "Which planet is known as the Blue Planet?", options: ["Neptune", "Uranus", "Earth", "Mars"], correctOption: "Earth", genres: ["Astronomy", "Solar System", "Planets"], tag: "Introduction" },
